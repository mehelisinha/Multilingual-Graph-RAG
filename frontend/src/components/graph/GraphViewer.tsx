...
export default function GraphViewer() {
  ...
  if (!data || data.nodes.length === 0) {
    return <div className="flex h-full items-center justify-center text-gray-500 bg-gray-50 border-gray-200 border rounded-lg">No graph data available. Search or select an entity.</div>;
  }
  ...
  const getNodeColor = (node: object) => {
    ...
    switch (n.label) {
      ...
      case 'Chunk': return '#9ca3af';
      case 'LegalArticle': return '#10b981';
      case 'Organisation': return '#f59e0b';
